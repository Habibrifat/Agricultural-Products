										...
										<div class="product-description">
											<div class="body-area">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="price" step="1" type="number" class="input-field" placeholder="{{ $langg->lang666 }}" value="{{round($data->price * $sign->value , 2)}}" required="" min="0">
													</div>
												</div>
												...
												<div class="row d-none">
													...
													<div class="col-lg-7">
														<input name="previous_price" step="1" type="number" class="input-field" placeholder="{{ $langg->lang666 }}" value="{{round($data->previous_price * $sign->value , 2)}}" min="0">
													</div>
												</div>
