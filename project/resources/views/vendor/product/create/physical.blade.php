						...
						<div class="product-description">
							<div class="body-area">
								...
								<div class="gocover"
									...
									<div class="showbox d-none" id="size-display">
										<div class="row">
											<div class="col-lg-12">
											</div>
											<div class="col-lg-12">
						...
						<div class="product-description">
							<div class="body-area">
										...
										<div class="col-lg-12">
											<div class="img-upload custom-image-upload">
												<div id="image-preview" class="img-preview"
													style="background: url({{ asset('assets/vendor/images/uploader.png') }});">
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input name="price" step="1" type="number" class="input-field"
									...
									<div class="row d-none">
										...
										<div class="col-lg-12">
											<input name="previous_price" step="1" type="number" class="input-field"
