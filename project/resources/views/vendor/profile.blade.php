													...
													<div class="col-lg-7">
														<div class="right-area">
																<h6 class="heading"> {{ $data->shop_name }}
																	<!--badge badge-success verify-link change-->
																	@if($data->checkStatus())
																	<a class="badge badge-success verify-link d-none" href="javascript:;">{{ $langg->lang783 }}</a>
																	@else
																	 <span class="verify-link d-none"><a href="{{ route('vendor-verify') }}">{{ $langg->lang784 }}</a></span>
																	@endif
																</h6>
														</div>
													</div>
