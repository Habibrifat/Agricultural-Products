...
@section('content')
    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading d-none">{{ $langg->lang549 }} <a class="add-btn" href="{{ route('vendor-order-index') }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
                                        <ul class="links">
                                            <li>
                                ...
                                <div class="col-lg-6">
                                    <div class="special-box">
                                        ...
                                        <div class="footer-area d-none">
                                            <a href="{{ route('vendor-order-invoice',$order->order_number) }}" class="mybtn1">{{ $langg->lang555 }}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                ...
                @endif
                                @endforeach
                                    ...
                                    <div class="col-lg-12 text-center mt-2 d-none">
