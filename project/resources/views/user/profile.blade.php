                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <input name="phone" type="tel" class="input-field"
                                                        ...
                                                        value="{{ $user->phone }}" pattern="[0]{1}[1]{1}[3-9]{1}[0-9]{8}" 
                                                        title="Starting with phone number 01, its next digit will be 3-9 and the remaining 8 digits will be between 0-9."
                                                        maxlength="11">
                                                </div>
                                                <!-- fax close -->
                                            ...
                                            <div class="row">
                                                    <div class="col-lg-6">
                                                            <input name="zip" type="text" class="input-field"
                                                                placeholder="Upazila" value="{{ $user->zip }}">
                                                    </div>
