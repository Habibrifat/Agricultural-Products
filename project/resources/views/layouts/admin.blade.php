		...
		<div class="page">
			<div class="page-main">
								...
								<ul class="list">
									...
									<li class="login-profile-area">
										<a class="dropdown-toggle-1" href="javascript:;">
											<div class="user-img">
												<img src="{{ Auth::guard('admin')->user()->photo ? asset('assets/images/admins/'.Auth::guard('admin')->user()->photo ):asset('assets/images/admin_.png') }}" alt="">
											</div>
										</a>
										<div class="dropdown-menu">
				...
				<div class="wrapper">
					...
					@if(Auth::guard('admin')->user()->IsSuper())
					<p class="version-name d-none "> {{ __('Version') }}: 2.1</p>
					@endif
					</nav>
