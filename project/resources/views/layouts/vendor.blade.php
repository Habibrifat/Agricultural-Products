	...
	<body>
		<div class="page">
			<div class="page-main">
              ...
              <img src="{{ Auth::user()->photo ? asset(Auth::user()->photo):asset('assets/images/farmer.png') }}" alt="">
              @else
              <img src="{{ Auth::user()->photo ? asset('assets/images/users/'.Auth::user()->photo ):asset('assets/images/farmer.png') }}" alt="">
              @endif
											</div>
										</a>
										<div class="dropdown-menu">
											<div class="dropdownmenu-wrapper">
													<ul>
														<h5>{{ $langg->lang431 }}</h5>
															...
															<li>
																<a href="{{ route('vendor-profile') }}"><i class="fas fa-user"></i> Edit vendor Profile</a>
															</li>
															<li>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a target="_blank" href="{{ route('front.vendor',str_replace(' ', '-', Auth::user()->shop_name)) }}" class="wave-effect"><i class="fas fa-store"></i> {{ $langg->lang440 }}</a>
							</li>
