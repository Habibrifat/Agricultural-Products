...
@endif
	...
	<section class="logo-header">
		<div class="container">
			<div class="row ">
				<div class="col-lg-2 p col-sm-4 col-3 remove-padding logo-image">
					<div class="logo">
				...
				<div class="col-lg-8 col-sm-12 remove-padding order-last order-sm-2 order-md-2 logo-search">
				...
				<div class="col-lg-2 col-sm-8 col-7 remove-padding order-lg-last logo-cart">
					<div class="helpful-links">
						<ul class="helpful-links-inner">
							...
							<li class="compare d-none"  data-toggle="tooltip" data-placement="top" title="{{ $langg->lang10 }}">
...
@yield('content')
	...
	<!-- Footer Area Start -->
	<footer class="footer" id="footer" style=" background-color:#142624 !important;">
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-lg-4">
					...
					<div class="fotter-social-links d-none">
						<ul>
									...
									<form class="mregisterform" action="{{route('user-register-submit')}}"
										...
										<div class="form-input">
											<input type="email" class="User Name" name="email"
												...
												pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" text="Invalid email">
											<i class="icofont-email"></i>
										</div>

										<div class="form-input">
											<input type="tel" class="User Name" id="phone" name="phone"
												placeholder="{{ $langg->lang184 }}" required="" maxlength="11"
												pattern="[0]{1}[1]{1}[3-9]{1}[0-9]{8}" title="Starting with phone number 01, its next digit will be 3-9 and the remaining 8 digits will be between 0-9.">
										...
										<div class="form-input">
											<input type="password" class="Password" name="password"
												...
												pattern="[a-zA-Z0-9]{4,}" title="at least Password length should be four.">
											<i class="icofont-ui-password"></i>
										</div>
