                                            ...
                                            <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="user-image">
                                                            ...
                                                            @endif
                                                        <a href="javascript:;" class="mybtn1 send d-none" data-email="{{ $data->email }}" data-toggle="modal" data-target="#vendorform">{{ __("Send Message") }}</a>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                    @if($data->checkStatus())
                                                                    <a class="badge badge-success verify-link d-none" href="javascript:;">Verified</a>
                                                                    <a class="set-gallery1 d-none" href="javascript:;" data-toggle="modal" data-target="#setgallery"><input type="hidden" value="{{ $data->verifies()->where('status','=','Verified')->first()->id }}">(View)</a>
                                                                    @else 
                                                                    <a class="badge badge-danger verify-link d-none" href="javascript:;">Unverified</a>
                                                                    @endif
                                                            </td>
                                                            <td>
                                                            </td>
