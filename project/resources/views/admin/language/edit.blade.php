                      ...
                      <hr>
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="" placeholder="Select Country" required="" value="{{ $lang->lang157 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang158" placeholder="District" required="" value="{{ $lang->lang158 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang159" placeholder="Upazila" required="" value="{{ $lang->lang159 }}">
                          </div>
                        </div>
