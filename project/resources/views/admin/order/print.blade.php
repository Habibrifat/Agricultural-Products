            ...
            <div class="invoice__metaInfo" style="margin-top:0px;">
                ...
                <div class="col-lg-6">
                        <div class="invoice__orderDetails" style="margin-top:5px;">
                           ...
                           <span><strong>{{ __('Division') }}</strong>: {{ $order->shipping_country == null ? $order->customer_country : $order->shipping_country }}</span>
                        </div>
                </div>
                @endif
                <div class="col-lg-6" style="width:50%;">
                        <div class="invoice__orderDetails" style="margin-top:5px;">
                            ...
                            <span><strong>{{ __('District') }}</strong>: {{ $order->customer_city }}</span><br>
                            <span><strong>{{ __('Division') }}</strong>: {{ $order->customer_country }}</span>
                        </div>
                </div>
            </div>
