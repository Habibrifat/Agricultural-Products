...
@section('content')
    <div class="content-area">
                                ...
                                <div class="col-lg-6">
                                    <div class="special-box">
                                        ...
                                        <div class="footer-area">
                                            <a href="{{ route('admin-order-invoice',$order->id) }}" class="mybtn1"> {{ __('View Invoice') }}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                ...
                <td width="45%">{{$order->shipping_address == null ? $order->customer_address : $order->shipping_address}}</td>
                                ...
                                <tr>
                                    <th width="45%"><strong>{{ __('Division') }}:</strong></th>
                                    <th width="10%">:</th>
                ...
                <td width="45%">{{$order->shipping_city == null ? $order->customer_city : $order->shipping_city}}</td>
                                ...
                                <tr>
                                    <th width="45%"><strong>{{ __('Upazila') }}:</strong></th>
                                    <th width="10%">:</th>
