...
<!-- Apply Hide -->
    ...
    <div class="row row-cards-one">
        ...
        <div class="col-md-6 col-lg-6 col-xl-6">
            <div class="card">
                <h5 class="card-header">{{ __('Recent Orders') }}</h5>
                <div class="card-body">
                        ...
                        <table class="table table-hover dt-responsive" cellspacing="0" width="100%">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-list"><a href="{{ route('admin-order-show',$data->id) }}"> {{ __('Details') }}</a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
        ...
        <div class="col-md-6 col-lg-6 col-xl-6">
                <div class="card">
                        <h5 class="card-header">{{ __('Recent Customers') }}</h5>
                        <div class="card-body">
                                ...
                                <table class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action-list"><a href="{{ route('admin-user-show',$data->id) }}"> {{ __('Details') }}</a>
                                                </div>
                                            </td>
                                        </tr>
                                        @endforeach
    ...
    <div class="row row-cards-one d-none">
            ...
            <div class="col-md-12 col-lg-12 col-xl-12">
                    <div class="card">
                            <h5 class="card-header">{{ __('Popular Products') }}</h5>
                            <div class="card-body">
    ...
    <div class="row row-cards-one">
            ...
            <div class="col-md-12 col-lg-12 col-xl-12">
                    <div class="card">
                            <h5 class="card-header">{{ __('Recent Products') }}</h5>
                            <div class="card-body">
