  ...
  <section class="sub-categori">
    <div class="container">
      <div class="row">
        ...
        <!-- New column -->
        <div class="col-lg-4 order-first order-lg-last m-auto">
          <div class="left-area-vendor">
            <h3 class="text-center my-4">Farmer Products</h3>
          </div>
          <img class="img-fluid" max-width="100%" height="80%" src="{{asset('assets/images/vendorbanner/farmer_hand.jpg')}}" alt="no image">
        </div>
        <!-- New column end -->
      </div>
    </div>
