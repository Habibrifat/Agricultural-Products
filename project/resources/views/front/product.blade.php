...
@php
      ...
      if($productt->user_id != 0){
        $vandor_price = $productt->price;
        $attrPrice = $gs->fixed_commission + (($productt->price/100) * $gs->percentage_commission);
