...
<!-- Breadcrumb Area End -->
    ...
    <section class="contact-us" style="background-image: url({{asset('assets/images/page/contact.jpg')}});
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact-section-title">
                            <!-- {!! $ps->contact_title !!} -->
                            <h6 class="display-4 text-center font-italic font-weighted text-white">Contact Us</h6>
                            <!-- {!! $ps->contact_text !!} -->
                            <p class="text-center font-weight-bold text-white mt-2 pt-4">Send us a message and we will respond as soon as possible.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="left-area">
                        <div class="contact-form">
                            <div class="gocover" style="background: url({{ asset('assets/images/'.$gs->loader) }}) no-repeat scroll contain right top rgba(45, 45, 45, 0.5);"></div>
                            <form id="contactform" action="{{route('front.contact.submit')}}" method="POST">
                                {{csrf_field()}}
                                    ...
                                    <div class="form-input">
                                            <input type="tel" name="phone" pattern="[0]{1}[1]{1}[3-9]{1}[0-9]{8}" title="Starting with phone number 01, its next digit will be 3-9 and the remaining 8 digits will be between 0-9."
                                             required="" maxlength="11" placeholder="{{ $langg->lang48 }} *">
																						<i class="icofont-ui-call"></i>
                                    </div>
                                    <div class="form-input">
                                            <input type="email" name="email"  placeholder="{{ $langg->lang49 }} *" required=""  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" text="Invalid email">
                        ...
                        <div class="contact-info ">
                            ...
                            <div class="content d-flex align-self-center">
                                <div class="content">
                                        ...
                                        <a href="{{$ps->site}}" target="_blank">{{$ps->site}}</a>
                                        @else
                                        <a class="text-white" href="mailto:{{$ps->email}}">{{$ps->email}}</a>
                                        @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="contact-info">
                                    ...
                                    <div class="content d-flex align-self-center">
                                        <div class="content">
                                            ...
                                            <a class="text-white" href="tel:{{$ps->phone}}">{{$ps->phone}}</a>
                                            @else
                                            <a href="tel:{{$ps->fax}}">{{$ps->fax}}</a>
                                            @endif
                                        </div>
