											...
											<div class="row">
												<div class="col-lg-6">
													<input class="form-control ship_input" type="text" name="shipping_city"
														id="shipping_city" placeholder="District">
												</div>
												<div class="col-lg-6">
													<input class="form-control ship_input" type="text" name="shipping_zip"
														id="shippingPostal_code" placeholder="Upazila">
												</div>
                       ...
                       @include('includes.admin.form-login')
                        <form id="registerform" action="{{route('user-register-submit')}}" method="POST">
                          {{ csrf_field() }}
                            ...
                            <div class="form-input">
                                <input type="tel" class="User Name" name="phone" placeholder="{{ $langg->lang184 }}" required="" maxlength="11"
