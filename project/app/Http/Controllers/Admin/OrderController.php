        ...
        elseif($status == 'declined') {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(Order $data) {
                                // class="send" using here; 
                                $orders = '<a href="javascript:;" data-href="'. route('admin-order-edit',$data->id) .'" class="delivery" data-toggle="modal" data-target="#modal1"><i class="fas fa-truck"></i> Delivery Status</a>';
                                return '<div class="godropdown"><button class="go-dropdown-toggle"> Actions<i class="fas fa-chevron-down"></i></button><div class="action-list"><a href="' . route('admin-order-show',$data->id) . '" > <i class="fas fa-check"></i> Details</a>'.$orders.'</div></div>';
                            }) 
